window.addEventListener("load", event => {
   ...
   const songs = [
      {
         img: "../media/merikansi.jpg",
         artistName: "Kalle Ahola & Puut",
         songName: "Meri josta elän",
         song: "../songs/01.mp3",
         color: "#ffffff"
      },
      {
      ...
      },
      {
         img: "../media/merikansi.jpg",
         artistName: "Kalle Ahola & Puut",
         songName: "Joo sen pitäisi olla niin",
         song: "../songs/09.mp3",
         color: "#ffffff"
      },
      {
